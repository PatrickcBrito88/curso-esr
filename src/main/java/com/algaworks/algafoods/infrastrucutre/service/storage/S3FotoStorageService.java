...
public class S3FotoStorageService implements FotoStorageService{
	...
	//Endereço: https://search.maven.org/artifact/com.amazonaws/aws-java-sdk-s3/1.12.233/jar
	...
	public void armazenar(NovaFoto novaFoto) {
		try {
			...
			var putObjectRequest = new PutObjectRequest(storageProperties.getS3().getBucket(),
				...
				//.withCannedAcl(CannedAccessControlList.PublicRead);//Permissao de leitura pública. Sem isso, a URL do objeto armazenado não pode ser acessado por ninguém
